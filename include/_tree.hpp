...
01   {
01     __y = __x;
01     __x = !_M_impl._M_key_compare(_S_key(__x), _KeyOfValue()(__v)) ?
01           _S_left(__x) : _S_right(__x);
01   }
   ...
   template<typename _Key, typename _Val, typename _KeyOfValue,
     ...
     {
       if (__j == begin())
         return pair<iterator, bool>(_M_insert_(__x, __y, _GLIBCXX_FORWARD(_Arg, __v)), true);
       else
         --__j;
     }
